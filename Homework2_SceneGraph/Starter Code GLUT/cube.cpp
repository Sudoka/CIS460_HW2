...
void cube::constructBuffers() {
	...
	/*normals[0]= 0.f; normals[1]= 0.f; normals[2]= 1.f; normals[3]= 0.f;
	normals[4]= 0.f; normals[5]= 0.f; normals[6]= 1.f; normals[7]= 0.f;
	normals[8]= 0.f; normals[9]= 0.f; normals[10]= 1.f; normals[11]= 0.f;
	normals[12]= 0.f; normals[13]= 0.f; normals[14]= 1.f; normals[15]= 0.f;*/
